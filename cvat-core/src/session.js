...
(() => {
    ...
    function buildDuplicatedAPI(prototype) {
        Object.defineProperties(prototype, {
            annotations: Object.freeze({
                value: {
                    async upload(file, loader,bands) {
    ...
    Job.prototype.annotations.upload.implementation = async function (file, loader,bands) {
        const result = await uploadAnnotations(this, file, loader,bands);
        return result;
    };
    ...
    Task.prototype.annotations.upload.implementation = async function (file, loader,bands) {
        console.log(bands);
        const result = await uploadAnnotations(this, file, loader,bands);
        return result;
    };
