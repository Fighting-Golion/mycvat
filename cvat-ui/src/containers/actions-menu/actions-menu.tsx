...
interface DispatchToProps {
    loadAnnotations: (taskInstance: any, loader: any, file: File,bands:string) => void;
...
function mapDispatchToProps(dispatch: any): DispatchToProps {
    return {
        loadAnnotations: (taskInstance: any, loader: any, file: File,bands:string): void => {
            dispatch(loadAnnotationsAsync(taskInstance, loader, file,bands));
        },
        showExportModal: (taskInstance: any): void => {
...
function ActionsMenuContainer(props: OwnProps & StateToProps & DispatchToProps): JSX.Element {
    ...
    function onUploadAnnotations(format: string, file: File,bands:string): void {
        const [loader] = loaders.filter((_loader: any): boolean => _loader.name === format);
        console.log(bands);
        if (loader && file) {
            loadAnnotations(taskInstance, loader, file,bands);
        }
    }
